...
public class HttpClient08PostJson {
    /**
    ...
    public static void main(String[] args) {
        ...
        jsonObject.put("userName","licretey");
        jsonObject.put("passwd","112233");
        StringEntity jsonEntity = new StringEntity(jsonObject.toString(), Consts.UTF_8);// 读取数据的编码
        jsonEntity.setContentType(new BasicHeader("Content-Type", "application/json; charset=utf-8")); // 内容编码
        // jsonEntity.setContentType("application/json; charset=utf-8"); // 内容编码
        jsonEntity.setContentEncoding(Consts.UTF_8.name()); // entity编码
        hpcPost.setEntity(jsonEntity);
