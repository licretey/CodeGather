 ...
 */
public class AtBeanPostProcessorConfig3 implements BeanFactoryPostProcessor {
    @Override
    public void postProcessBeanFactory(ConfigurableListableBeanFactory configurableListableBeanFactory) throws BeansException {
        try{
            ...
            MetadataReader reader = factory.getMetadataReader(new ClassPathResource("com/sourceLearn/a05/Config3.class"));
            ...
            for (MethodMetadata method : beanMethods) {
                ...
                builder.setFactoryMethodOnBean(method.getMethodName(), "config3");
                // 设置对构造方法、工厂方法的自动装配方式
